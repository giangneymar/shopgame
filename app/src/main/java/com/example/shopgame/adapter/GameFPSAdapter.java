...
public class GameFPSAdapter extends BaseAdapter {

    Context context;
    ArrayList<Game> gameFPSArrayList;

    public GameFPSAdapter(Context context, ArrayList<Game> gameFPSArrayList) {
        this.context = context;
        this.gameFPSArrayList = gameFPSArrayList;
    }

    @Override
    public int getCount() {
        return gameFPSArrayList.size();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.row_game_fps, null);
        ...
        Game game = gameFPSArrayList.get(i);
